 ...
 */
public class CosmosSetExpressionVisitor extends BaseExpressionVisitor {
    ...
    public CosmosSetExpressionVisitor() {
    ...
    public void endVisitAnd() {
        throw new CosmosTableException("CosmosDB Event Table does not support SET function.");
    }
